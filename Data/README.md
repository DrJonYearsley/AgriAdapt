...
| ------------| ------------------------|
|`dly575.csv` | Daily meteo data for Moore Park From 10/08/2003 to Present |
| `hly575.csv` | Hourly meteo data for MorePark From 10/08/2003 to Present | 
| `hly375.csv` | Hourly meteo data for Oakpark From 12/08/2003 to Present
...
See https://data.gov.ie/dataset/moore-park-hourly-data
